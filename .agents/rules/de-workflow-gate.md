...
1. Every ticket, plan, spec, ADR, and PR must remain linked in `docs/dashboard/kanban-data.json` and viewable via [docs/dashboard/index.html](file:///c:/Users/G988557/Documents/Code/antigravity/data-recon/docs/dashboard/index.html).
