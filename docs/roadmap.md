...
| 2 | V2-1.2 Atomic Staging & Snapshot Commit Pipeline | **TODO** | — | `version-two/ducklake/reload_pipeline.py`, Snowflake/GCS stage |
...
| # | Story / Ticket | Status | Blocked On | Touches |
|---|---|---|---|---|
| 4 | V2-2.1 Cube.js 1.7.x Core Engine with Embedded DuckDB & DuckLake Extension | **TODO** | V2-1.1, V2-1.3 | `version-two/cube/package.json`, `version-two/cube/cube.js` |
...
| 11 | V2-4.2 Concurrency & Zero-Torn-Reads Verification Harness | **TODO** | V2-1.2, V2-2.1 | `version-two/tests/test_concurrency_acid.py` |
